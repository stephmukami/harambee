...
const secondOnboarding = () => {
  return (
             ...
             <Image
               style={styles.logo}
               resizeMode="contain"
               source={require("../assets/images/pay-online.png")}
             />
       
             <Text style={styles.explainer}>Ipsum lorem dolor sit amet consectetur adipisicing elit. Labore, perspiciatis!</Text>
       
             {/* Pagination dots */}
             <View style={styles.dots}>

              {/* shd be index/splash screen */}
